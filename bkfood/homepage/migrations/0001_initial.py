    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2025, 4, 24, 9, 11, 19, 749400))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2025, 4, 24, 9, 11, 19, 749703))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('like', models.IntegerField(default=0)),
                ('dislike', models.IntegerField(default=0)),
                ('time', models.DateTimeField(default=datetime.datetime(2025, 4, 24, 9, 11, 19, 749221))),
            ],
        ),
        migrations.CreateModel(
            name='Manager',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2025, 4, 24, 9, 11, 19, 750345))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.DateTimeField(default=datetime.datetime(2025, 4, 24, 9, 11, 19, 750227))),
                ('content', models.TextField()),
                ('like', models.IntegerField(default=0)),
                ('account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.account')),
