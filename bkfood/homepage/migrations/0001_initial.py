# Generated by Django 4.2.19 on 2025-05-11 13:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2025, 5, 11, 20, 16, 39, 66230))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2025, 5, 11, 20, 16, 39, 66898))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('time', models.DateTimeField(default=datetime.datetime(2025, 5, 11, 20, 16, 39, 66767))),
                ('content', models.TextField()),
                ('like', models.IntegerField(default=0)),
                ('account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='homepage.account')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(max_length=50)),
                ('name_stripped', models.TextField(max_length=50, null=True)),
                ('type', models.CharField(choices=[('beverages', 'Beverages'), ('food', 'Food'), ('entertainment', 'Entertainment'), ('services', 'Services')], max_length=20)),
                ('price', models.IntegerField(default=0)),
                ('img', models.ImageField(default='default.jpg', upload_to=homepage.models.img_path_product)),
                ('description', models.TextField(blank=True, null=True)),
                ('like', models.IntegerField(default=0)),
                ('dislike', models.IntegerField(default=0)),
                ('time', models.DateTimeField(default=datetime.datetime(2025, 5, 11, 20, 16, 39, 66064))),
